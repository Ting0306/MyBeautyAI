...
def get_openai_response():
    ...
    model="gpt-3.5-turbo", 
    messages=[
        {"role": "system", "content": f"你是一個美容產品專員，負責招待客人，你剛剛推薦{product_result}這項產\
                品給{string_result}的客人了解，繼續解決客人的疑問，也可以推薦不同的產品，回答內容在50字以內"},
...
if __name__== "__main__":
    ...
    model="gpt-3.5-turbo", 
    messages=[
        {"role": "system", "content": "你是一個廣告文案師，請寫一段低於40字的中文廣告，將" + product_result + "的功效以及好處推薦給" + string_result + "年齡段的消費者"},
